  ...
  return (
    <div className=" items-center  justify-center gap-4 hidden min-[1300px]:flex">
      <Link href="/">
        ...
        <img src={logo8} alt="TerraStore Logo" className="w-12 h-11 rounded-full border-2 border-orange-700 hover:scale-110 translate-x-3 "/>
      </Link>
      <h1 className="font-inter font-bold text-2xl ">TerraStore</h1>
    </div>
  );
};
export default Logo;
